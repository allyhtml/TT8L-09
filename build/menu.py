...
from tkinter import Tk, Canvas, Button, PhotoImage, Label, messagebox, font, Entry, Toplevel, Frame
import sys
import os
import subprocess
import random 
...
# Amira's First code: Sign-in and Registration System
def signin():
    email = user.get()
    password = code.get()
...
# Amira's Main application setup
root = tk.Tk()
