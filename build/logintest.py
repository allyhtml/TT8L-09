...
from tkinter import Tk, font, messagebox, PhotoImage, Label, Frame, Entry, Button, Toplevel
from test_copy import show_frame0
import os
...
image_paths = {
        'logo': os.path.join(current_dir, "Design/logo.png"),
    }
...
if images['logo']:
        logo_label = tk.Label(quiz_frame, image=images['logo'], bg="#FFC8C0")
        logo_label.place(x=-100, y=60)
else:
